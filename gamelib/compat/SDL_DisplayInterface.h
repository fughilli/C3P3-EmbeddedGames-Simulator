...
class SDL_DisplayInterface {
 ...
 public:
  SDL_DisplayInterface(SDL_Surface*& surface, SDL_Surface*& wsurface,
                       SDL_Window*& _wwindow, uint8_t outputScale = 1);
  ~SDL_DisplayInterface();
  static SDL_DisplayInterface* createWindow(uint32_t w, uint32_t h,
                                            SDL_Window*& retwindow,
                                            uint8_t outputScale = 1);
