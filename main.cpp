  ...
  while (true) {
    ...
    if (SDL_PollEvent(&gameEvent)) {
      ...
      if (gameEvent.type == SDL_KEYDOWN || gameEvent.type == SDL_KEYUP) {
        ...
        if (gameEvent.type == SDL_KEYDOWN) buttonflag = 1;

        switch (gameEvent.key.keysym.scancode) {
          case SDL_SCANCODE_W:
            sim_hooked_buttons.buttons.p_up = sim_hooked_buttons.buttons.up =
                buttonflag;
            break;
          case SDL_SCANCODE_A:
            sim_hooked_buttons.buttons.p_left =
                sim_hooked_buttons.buttons.left = buttonflag;
            break;
          case SDL_SCANCODE_S:
            sim_hooked_buttons.buttons.p_down =
                sim_hooked_buttons.buttons.down = buttonflag;
            break;
          case SDL_SCANCODE_D:
            sim_hooked_buttons.buttons.p_right =
                sim_hooked_buttons.buttons.right = buttonflag;
            break;
          case SDL_SCANCODE_H:
            sim_hooked_buttons.buttons.p_a = sim_hooked_buttons.buttons.a =
                buttonflag;
            break;
          case SDL_SCANCODE_U:
            sim_hooked_buttons.buttons.p_b = sim_hooked_buttons.buttons.b =
                buttonflag;
            break;
          default:
            break;
